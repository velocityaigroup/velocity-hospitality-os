...
Requires AWS credentials in the environment / instance role and Bedrock model
access enabled in the target region.
"""
...
from .base import SYSTEM_PROMPT, build_prompt
    ...
    def answer(self, question: str, contexts: list[str]) -> str:
        ...
        resp = client.invoke_model(
            ...
            body=json.dumps({
                ...
                "messages": [
                    {"role": "user",
                     "content": [{"type": "text", "text": build_prompt(question, contexts)}]}
                ],
            }),
        )
        payload = json.loads(resp["body"].read())
